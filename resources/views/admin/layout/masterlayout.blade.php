            ...
            <div class="sidebar h-100">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="{{route('estimatecomplete.index')}}" class="sidebar-link"><i class="fa-solid fa-folder-open pe-2"></i>Qoutes</a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{route('blog.index')}}" class="sidebar-link"><i class="fa-regular fa-square-plus pe-2"></i>Blogs</a>
                    </li>
                ...
                <div class="navbar-collapse navbar">
                    <ul class="navbar-nav">
                        <li class="nav-item align-self-center flex-wrap px-4">
                            <p class="marquee">
                                <span> <strong>Abdul Rehman</strong> &nbsp;&nbsp;&nbsp; </span>
                            </p>
                        </li>
